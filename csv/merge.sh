...
echo "dist,L90,L45,F,R45,R90,L45_2,R_45_2"> result_l.csv
echo "dist,L90,L45,F,R45,R90,L45_2,R_45_2"> result_r.csv
# echo "dist,L90,L45,F,R45,R90,L45_2,R_45_2"> result_f.csv
